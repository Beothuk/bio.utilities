...
#' @description This function determines the percentage of Dissolved oxygen in solution at a given temperature and salinity given a known saturation amount
#' @note formula attributed to Weiss DSR 17, 721-735, 1970
